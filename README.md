...
*Insight: Balanced popularity and customer satisfaction to identify top performers.*
 <br> <br>
> see complete excel filesand dashboard here: (https://drive.google.com/drive/folders/1j5wBllnXuZCMJ9PUK9lV_vGdKwD04nCD?usp=drive_link) 
...
![](dashboard.png) <br>
 ...
 > Click here to access the complete project Excel file and interactive dashboard via Google Drive: (https://drive.google.com/drive/folders/1j5wBllnXuZCMJ9PUK9lV_vGdKwD04nCD?usp=drive_link)<br>
